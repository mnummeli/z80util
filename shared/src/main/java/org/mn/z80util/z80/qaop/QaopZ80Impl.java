        ...
        for (;;) {
            ...
            switch (c) {
                ...
                case 0x1E:
                    ...
                    break;
                case 0x24:
                    xy = xy & 0xFF | inc(xy >>> 8) << 8;
                    break;
                case 0x25:
                    xy = xy & 0xFF | dec(xy >>> 8) << 8;
                    break;
                case 0x26:
                    xy = xy & 0xFF | imm8() << 8;
                    break;
                case 0x2C:
                    xy = xy & 0xFF00 | inc(xy & 0xFF);
                    break;
                case 0x2D:
                    xy = xy & 0xFF00 | dec(xy & 0xFF);
                    break;
                case 0x2E:
                    xy = xy & 0xFF00 | imm8();
                    break;
                case 0x34: {
                    int a, v = inc(env.mem(a = getd(xy)));
                    time += 4;
                    env.mem(a, v);
                    time += 3;
                }
                ...
                break;
                case 0x36: {
                    int a = (char) (xy + (byte) env.mem(PC));
                    time += 3;
                    int v = env.mem((char) (PC + 1));
                    time += 5;
                    env.mem(a, v);
                    PC = (char) (PC + 2);
                    time += 3;
                ...
                // case 0x64: break;
                case 0x65:
                    xy = xy & 0xFF | (xy & 0xFF) << 8;
                    break;
                case 0x66:
                    HL = HL & 0xFF | env.mem(getd(xy)) << 8;
                    time += 3;
                    break;
                case 0x67:
                    xy = xy & 0xFF | A << 8;
                ...
                case 0x73:
                    ...
                    break;
                case 0x74:
                    env.mem(getd(xy), HL >>> 8);
                    time += 3;
                    break;
                case 0x75:
                    env.mem(getd(xy), HL & 0xFF);
                    time += 3;
                    break;
                case 0x76:
                    halt();
    ...
    private void group_ed() {
        ...
        switch (c) {
            ...
            case 0x6F:
                ...
                break;
            case 0x40:
                f_szh0n0p(B = env.in(B << 8 | C));
                time += 4;
                break;
            case 0x48:
                f_szh0n0p(C = env.in(B << 8 | C));
                time += 4;
                break;
            case 0x50:
                f_szh0n0p(D = env.in(B << 8 | C));
                time += 4;
                break;
            case 0x58:
                f_szh0n0p(E = env.in(B << 8 | C));
                time += 4;
                break;
            case 0x60: {
                int v = env.in(B << 8 | C);
            ...
            break;
            case 0x70:
                f_szh0n0p(env.in(B << 8 | C));
                time += 4;
                break;
            case 0x78:
                f_szh0n0p(A = env.in(B << 8 | C));
                time += 4;
                break;
            case 0x41:
                env.out(B << 8 | C, B);
            ...
            case 0x4A:
                ...
                break;
            case 0x43:
                env.mem16(imm16(), B << 8 | C);
                time += 6;
                break;
            case 0x4B: {
                int v = env.mem16(imm16());
                B = v >>> 8;
                C = v & 0xFF;
            }
            time += 6;
    ...
    private void group_cb() {
        ...
        switch (c & 0xC7) {
            ...
            case 0x03:
                ...
                break;
            case 0x04:
                HL = HL & 0xFF | shifter(o, HL >>> 8) << 8;
                break;
            case 0x05:
                HL = HL & 0xFF00 | shifter(o, HL & 0xFF);
                break;
            case 0x06: {
                int v = shifter(o, env.mem(HL));
                time += 4;
                env.mem(HL, v);
                time += 3;
            }
