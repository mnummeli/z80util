...
public final class Disassembler {
	...
	private static final String[] misc1=
		{"RLCA","RRCA","RLA","RRA","DAA","CPL","SCF","CCF"};
	
	private static final String[] misc2=
		{"ADD","ADC","SUB","SBC","AND","XOR","OR","CP"};
	
	private static final String[] misc3=
		{"RLC","RRC","RL","RR","SLA","SRA","SLL","SLR"};
	
	private static final String[] misc4=
		{null,"BIT","RES","SET"};
	
	private static final String[] misc5=
		{"LDI" ,"CPI" ,"INI" ,"OUTI",
		 "LDD" ,"CPD" ,"IND" ,"OUTD",
		 "LDIR","CPIR","INIR","OTIR",
		 "LDDR","CPDR","INDR","OTDR"};
