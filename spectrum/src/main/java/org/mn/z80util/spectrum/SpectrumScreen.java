...
public class SpectrumScreen extends JPanel {
	...
	/**
	 * The RGB integer array of Spectrum colors.
	 * Change this in order to fix the colors appearance.
	 */
	...
	public static final int WIDTH              = BORDER_WIDTH + PAPER_WIDTH  + BORDER_WIDTH;
	public static final int HEIGHT             = BORDER_WIDTH + PAPER_HEIGHT + LOWER_BORDER_WIDTH;
	
	/**
	 * Initializes the screen with Spectrum-related measures of paper
	 * area and colors.
	 */
	...
	public void updateRow(int row) {
		repaint(0,SCALE*row,SCALE*WIDTH,SCALE);
	}
