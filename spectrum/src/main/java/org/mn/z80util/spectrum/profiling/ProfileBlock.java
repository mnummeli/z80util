...
public class ProfileBlock implements Comparable<ProfileBlock> {
    ...
    /**
     * Another set of predecessors and successors, which should be in some cases
     * a translation of predecessor and successor addresses into their order
     * numbers in a program block array.
     */
    ...
    /**
     * A helper function for determining whether this profile block is probably
     * innermost in a loop structure. Requires that profile blocks are sorted
     * according to their frequencies/densities in descending order and that
     * block order number of this block is provided.
     *
     * @param orderno	Order number of this profile block
     * @return	True if this block has no successors or predecessors with lower
     * order number than this block has, false otherwise
     */
    ...
    /**
     * A pretty printer of the frequency value,
     * distinguishes between Hz and
     * kHz.
     *
