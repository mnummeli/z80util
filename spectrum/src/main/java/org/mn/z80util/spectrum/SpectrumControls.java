...
public class SpectrumControls implements KeyListener, ActionListener {
    ...
    /* Keyboard listener */
    /**
     * Processes key presses and releases and sends them to the ULA. From
     * Spectrum configuration, note that:
     *
     * <ul> <li>Left SHIFT stands for CAPS SHIFT.</li> <li>Right SHIFT stands
     * for BREAK SPACE.</li> <li>BACKSPACE stands for ERASE, i.e. 0 CAPS SHIFT
     * and 0 combined.</li> <li>COMMA, PERIOD, MINUS, ALT and ALT-GR stand for
     * SYMBOL SHIFT.</li> </ul>
     *
